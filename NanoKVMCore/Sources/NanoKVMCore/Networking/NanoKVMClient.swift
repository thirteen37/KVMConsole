...
public enum NanoKVMError: Error, LocalizedError, Equatable {
    case invalidURL
...
public actor NanoKVMClient {
    public let device: Device
    private let session: URLSessionProtocol
    public private(set) var token: String?

    public init(device: Device, session: URLSessionProtocol = URLSession.shared) {
        self.device = device
    ...
    public func vmInfo() async throws -> VMInfo {
    ...
    public func selectH264() async throws {
    ...
    public func paste(_ content: String, language: String = "en") async throws {
...
public struct VMInfo: Decodable, Sendable, Equatable {
    public struct IP: Decodable, Sendable, Equatable {
