...
enum NanoKVMPasswordEncryptorError: Error, LocalizedError, Equatable {
...
enum NanoKVMPasswordEncryptor {
    ...
    static func encrypt(_ password: String, salt: Data) throws -> String {
