...
enum H264StreamError: Error, LocalizedError, Equatable {
    case invalidURL
    case frameTooShort
    case emptyPayload
...
struct H264StreamFrame: Equatable, Sendable {
    let isKeyFrame: Bool
    let timestampMicros: UInt64
    let payload: Data
}

enum H264StreamFrameParser {
    static func parse(_ data: Data) throws -> H264StreamFrame {
...
final class H264StreamSocket: @unchecked Sendable {
    ...
    func frames() throws -> AsyncThrowingStream<H264StreamFrame, Error> {
